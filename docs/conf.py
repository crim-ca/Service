...
from VestaService.__meta__ import __version__
...
htmlhelp_basename = 'Service_Workerdoc'
...
intersphinx_mapping = {'celery': ("http://docs.celeryproject.org/en/latest/", None),
                       'sg': ('http://services.vesta.crim.ca/docs/sg/latest/',
